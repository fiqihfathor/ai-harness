...
> How to write code well in *this* project's actual stack: conventions,
> recommended patterns, a commands cheat-sheet, and common footguns —
> per technology actually in use. This is different from `tech-stack.md`
...
### Conventions
<idioms and patterns specific to this technology, as used in this project>

### Recommended patterns
<what to do for common tasks in this technology>

### Commands cheat-sheet
```
<common commands: run, test, lint, generate, migrate, etc.>
```
